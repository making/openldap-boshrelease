...
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/a/apache2/apache2-bin_2.4.18-2ubuntu3.8_amd64.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/a/apache2/apache2-utils_2.4.18-2ubuntu3.8_amd64.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/a/apache2/apache2-data_2.4.18-2ubuntu3.8_all.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/a/apache2/apache2_2.4.18-2ubuntu3.8_amd64.deb"
DEBS="$DEBS http://kr.archive.ubuntu.com/ubuntu/pool/main/p/php-defaults/php-common_35ubuntu6_all.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/php7.0-common_7.0.30-0ubuntu0.16.04.1_amd64.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/php7.0-json_7.0.30-0ubuntu0.16.04.1_amd64.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/php7.0-opcache_7.0.30-0ubuntu0.16.04.1_amd64.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/php7.0-readline_7.0.30-0ubuntu0.16.04.1_amd64.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/php7.0-cli_7.0.30-0ubuntu0.16.04.1_amd64.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/libapache2-mod-php7.0_7.0.30-0ubuntu0.16.04.1_amd64.deb"
DEBS="$DEBS http://kr.archive.ubuntu.com/ubuntu/pool/main/p/php-defaults/libapache2-mod-php_7.0+35ubuntu6_all.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/php7.0-ldap_7.0.30-0ubuntu0.16.04.1_amd64.deb"
DEBS="$DEBS http://kr.archive.ubuntu.com/ubuntu/pool/main/p/php-defaults/php-ldap_7.0+35ubuntu6_all.deb"
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/main/p/php7.0/php7.0-xml_7.0.30-0ubuntu0.16.04.1_amd64.deb"
...
DEBS="$DEBS http://security.ubuntu.com/ubuntu/pool/universe/p/phpldapadmin/phpldapadmin_1.2.2-5.2ubuntu2.1_all.deb"
